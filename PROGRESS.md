...
- Blockers: local verifier is green and both iOS and Android runtime proof are now automated, but live AdMob app and unit IDs, RevenueCat public/server credentials, and store product mapping are still required for honest completion
