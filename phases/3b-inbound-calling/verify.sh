...
check "iOS includes voicemail and remote notification background modes" bash -lc "rg -F -q 'remote-notification' FreeLine-iOS/project.yml && rg -F -q 'voip' FreeLine-iOS/project.yml"
check "iOS voicemail screen supports in-app playback" bash -lc "rg -F -q 'AVPlayer' FreeLine-iOS/Sources/Calls/VoicemailPlaybackController.swift && rg -F -q 'Play Recording' FreeLine-iOS/Sources/Screens/VoicemailView.swift"
